...
public class WorkerRoutes : ApiContextBase<IConnection>, IWorkerRoutes
{
    ...
    {
        var requestUri = new RelativeUri($"{ZoneEndpoints.Base}/{zoneId}/{WorkerRouteEndpoints.Base}");
    ...
    {
        var requestUri = new RelativeUri($"{ZoneEndpoints.Base}/{zoneId}/{WorkerRouteEndpoints.Base}/{identifier}");
