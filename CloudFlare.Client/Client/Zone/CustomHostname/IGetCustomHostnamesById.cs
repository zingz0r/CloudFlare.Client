...
namespace CloudFlare.Client
{
    public interface IGetCustomHostnamesById
    {
        ...
        /// <returns></returns>
        Task<CloudFlareResult<IReadOnlyList<CustomHostname>>> GetCustomHostnamesByIdAsync(string zoneId);
        ...
        /// <returns></returns>
        Task<CloudFlareResult<IReadOnlyList<CustomHostname>>> GetCustomHostnamesByIdAsync(string zoneId, CancellationToken cancellationToken);
        ...
        /// <returns></returns>
        Task<CloudFlareResult<IReadOnlyList<CustomHostname>>> GetCustomHostnamesByIdAsync(string zoneId, string customHostnameId);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns></returns>
        Task<CloudFlareResult<IReadOnlyList<CustomHostname>>> GetCustomHostnamesByIdAsync(string zoneId, string customHostnameId, CancellationToken cancellationToken);
        ...
        /// <returns></returns>
        Task<CloudFlareResult<IReadOnlyList<CustomHostname>>> GetCustomHostnamesByIdAsync(string zoneId, string customHostnameId, int? page);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns></returns>
        Task<CloudFlareResult<IReadOnlyList<CustomHostname>>> GetCustomHostnamesByIdAsync(string zoneId, string customHostnameId, int? page, CancellationToken cancellationToken);
