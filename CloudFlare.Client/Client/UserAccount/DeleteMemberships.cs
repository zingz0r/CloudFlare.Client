...
namespace CloudFlare.Client
{
    ...
    {
        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<UserMembership>>> DeleteMembershipAsync(string membershipId)
        {
        ...
        {
            return await _httpClient.DeleteAsync<IReadOnlyList<UserMembership>>(
