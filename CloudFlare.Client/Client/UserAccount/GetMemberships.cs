...
namespace CloudFlare.Client
{
    ...
    {
        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<UserMembership>>> GetMembershipsAsync()
        {
            return await GetMembershipsAsync(null, null, null, null, null, null, default).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<UserMembership>>> GetMembershipsAsync(CancellationToken cancellationToken)
        {
            return await GetMembershipsAsync(null, null, null, null, null, null, cancellationToken).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<UserMembership>>> GetMembershipsAsync(MembershipStatus? status)
        {
