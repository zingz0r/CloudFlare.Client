...
namespace CloudFlare.Client
{
    ...
    {
        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<Account>>> GetAccountsAsync()
        {
            return await GetAccountsAsync(null, null, null, default).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<Account>>> GetAccountsAsync(CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        public async Task<CloudFlareResult<IReadOnlyList<Account>>> GetAccountsAsync(int? page)
        {
